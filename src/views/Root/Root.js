...
class Root extends React.Component {
  ...
  fetchBriefs = () => {
    ...
    setTimeout(() => {
      axios
        .get(
          `${API_URL}/briefs?wsp_statuss=wersja_robocza&wsp_statuss=do_wyceny&_sort=wsp_pilne:DESC,wsp_przekazane_do_wyceny:ASC&_limit=-1`,
          {
            headers: {
              Authorization: `Bearer ${this.state.userToken}`
            }
  ...
  fetchPricedBriefs = () => {
    ...
    setTimeout(() => {
      axios
        .get(
          `${API_URL}/briefs?wsp_statuss=wycenione&_sort=wsp_statuss_date:DESC&_limit=-1`,
          {
            headers: {
              Authorization: `Bearer ${this.state.userToken}`
            }
  ...
  fetchFiles = () => {
    ...
    setTimeout(() => {
      axios
        .get(`${API_URL}/pliks?_sort=file_name:asc`, {
          headers: {
            Authorization: `Bearer ${this.state.userToken}`
          }
        })
