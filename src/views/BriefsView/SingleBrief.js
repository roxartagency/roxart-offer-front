...
class SingleBriefView extends React.Component {
  ...
  componentDidMount() {
    ...
    this.context.fetchSingleBrief(id);
  }
                  ...
                  <>
                    <BriefWrapper key={item.id}>
                      <form
                        ...
                        className=""
                        onSubmit={e =>
                          context.editItem(e, item.id, this.state)
                        }></form>
                      <InfoWrapper>
                        <InfoWrapperLeft>
                          <InfoContent>
                          ...
                          <InfoContent>
                            ...
                            <InfoContentContent>{item.id}</InfoContentContent>
                          </InfoContent>
                      ...
                      <MainWrapper>
                        <LeftWrapper>
                          <>
                            ...
                            <Row>
                              ...
                              <Content>
                                {context.allowEdit(
                                  ...
                                  <StaticInfo>{item.wsp_adres_url}</StaticInfo>
                                )}
                              </Content>
                            </Row>
                            ...
                            <Row>
                              ...
                              <Content>
                                {context.allowEdit(
                                  ...
                                  <StaticInfo>{item.wsp_konkurenci}</StaticInfo>
                                )}
                              </Content>
                            </Row>
                            ...
                            <Row>
                              <Label>
                                8. Jaki jest określony czas zakończenia
                                realizacji projektu?
                              </Label>
                              <Content>
                                {context.allowEdit(
                            ...
                            {item.kategoria.id === 1 ? (
                              <>
                                <Row>
                                  <Label>
                                    9. Czy firma posiada logo? Jeśli tak, czy
                                ...
                                <Row>
                                  <Label>
                                    10. Jakie są założenia i podstawowy cel
                                ...
                                <Row>
                                  <Label>
                                    11. Jaki ma być charakter strony
                                ...
                                <Row>
                                  <Label>
                                    12. Czy strona ma mieć możliwość
                                ...
                                <Row>
                                  <Label>
                                    13. Jaki ma być podstawowy język strony?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    14. Czy strona posiadać dodatkowe języki?
                                    Jeśli tak, to jakie?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    16. Jaka jest orientacyjna liczba wszystkich
                                ...
                                <Row>
                                  <Label>
                                    17. Jakie są Twoje oczekiwania co do
                                    kolorystyki strony?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    18. Przykłady istniejących stron
                                    internetowych, które podobają się Tobie.
                                    Podaj minimum trzy przykłady. (nie muszą być
                                    związane z branżą)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    19. Elementy na istniejących stronach
                                    internetowych, które podobają się Tobie.
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    20. Czy otrzymamy zdjęcia do strony?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    21. Czy otrzymamy teksty do strony?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                      ...
                                      <StaticInfo>{item.str_teksty}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    22. Elementy zewnętrzne do umieszczenia na
                                ...
                                <Row>
                                  <Label>
                                    23. Czy strona ma mieć dodatkową
                                ...
                                <Row>
                                  <Label>
                                    24. Czy firma posiada wykupioną domenę
                                ...
                                <Row>
                                  <Label>
                                    25. Czy firma posiada wykupiony
                              ...
                              <>
                                <Row>
                                  <Label>
                                    9. Czy firma posiada logo? (Jeśli tak, czy
                                    firma posiada logo w formie pliku
                                    wektorowego oraz czy macie do logo wykonaną
                                    księgę znaku?)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    10. Czy firma obecnie posiada katalog? Jeśli
                                ...
                                <Row>
                                  <Label>
                                    11. Czy katalog ma być przygotowany do
                                    ...
                                    oraz internetu, gdy podstawowe przygotowanie
                                    jest do druku.
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    12. Czy wybrali już Państwo drukarnię do
                                    wydruku katalogów? Jaki nakład katalogów
                                    jest przewidywany? Prosimy o podanie ilość
                                    sztuk. Jeśli będzie to np. tylko 10 sztuk to
                                    katalog może być inaczej przygotowany do
                                    druku. Jeśli wydruk ma być niestandardowy,
                                    będziemy potrzebować wytycznych od drukarni
                                ...
                                <Row>
                                  <Label>
                                    13. *Jaki format powinien mieć katalog?
                                    Standardowe formaty: A4, A5, A6, kwadrat.
                                    Jeśli inny, prosimy podać dokładne wymiary.
                                    (Miej na uwadze: Jeśli format będzie inny
                                    niż standardowy to koszy wydruku mogą
                                    wzrosnąć nawet 100%)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.kat_format}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    14. Jaka będzie orientacja katalogu?
                                ...
                                <Row>
                                  <Label>
                                    15. *Czy przewidują Państwo uszlachetnienie
                                    lakierem wybiórczym np. na okładce lub
                                    innych stronach? (Jeśli tak, opracujemy dla
                                    drukarni makietę z wybranymi elementami,
                                    które mają być lakierowane)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    16. *Ile stron powinien zawierać katalog?
                                    Aby katalog został wydrukowany i złożony,
                                    ilość stron musi być podzielna przez 4.
                                    Przykład: 8 stron czyli 4 strony okładki + 4
                                    strony środka. (Przykłady standardowych
                                    rozmiarów stron: 8, 12, 16, 20, 24, 28, 32,
                                    36, 40, 44, 48, 52 … 88, 92,96, 100)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    17. *Jaki jest cel nowego katalogu? Prosimy
                                    opisać jakie mają Państwo oczekiwania co do
                                    katalogu, co będzie zawierał, jakie ma
                                    spełnić zadania i do czego będzie służył. (
                                    Przykład: katalog będzie służ
                                    przedstawicielom na spotkaniach z klientem
                                    oraz na targach. będzie zawierał informacje
                                    o firmie jej historia i strukturę.
                                    Przedstawimy koło 20 najlepszych produktów z
                                    dokładnym podziałem na 3 kategorie. Każdy
                                    produkt będzie zawierał dokładny opis
                                    zdjęcie warianty i cennik. Chcemy zamieścić
                                ...
                                <Row>
                                  <Label>
                                    18. Czy katalog ma nawiązywać do strony
                                ...
                                <Row>
                                  <Label>
                                    19. *W jakim języku będą treści do katalogu?
                                    Lub Czy katalog będzie zawierał kilka
                                    języków w jednym katalogu?Jeśli tak prosimy
                                    podać w jakich.
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    20. *Czy katalog również ma być projektowany
                                    w innych językach niż standardowy? Jeśli tak
                                    to w jakim jeszcze.
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    22. *Przykłady istniejących katalogów, które
                                ...
                                <Row>
                                  <Label>
                                    23. Elementy na istniejących katalogach,
                                ...
                                <Row>
                                  <Label>
                                    24. Na jakim etapie gromadzenia materiałów
                                    do katalogu są Państwo? (Przykład: jesteśmy
                                    w połowie pisania treści resztę mamy
                                ...
                                <Row>
                                  <Label>
                                    25. *Czy otrzymamy zdjęcia do katalogu przed
                                ...
                                <Row>
                                  <Label>
                                    26. *Czy otrzymamy teksty do katalogu przed
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.kat_teksty}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    27. *Jakie dodatkowe materiały do
                                    projektowania dostaniemy? Np. loga firm,
                                    hasła reklamowe, itp. które są niezbędne do
                                ...
                                <Row>
                                  <Label>
                                    28. Czy potrzebują Państwo pliki edytowalne
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.kat_pliki}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    29. Prosimy podać inne dodatkowe informacje,
                            ...
                            {item.kategoria.id === 3 ? (
                              <>
                                ...
                                <Row>
                                  <Label>
                                    10. Jaka dokładna nazwa ma się znajdować w
                                    logo? np. ROXART
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.logo_nazwa}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    11. Czy ma być dodatkowy podpis do głównej
                                ...
                                <Row>
                                  <Label>
                                    12. Ile propozycji logotypów mamy
                                ...
                                <Row>
                                  <Label>
                                    13. Czy mamy przygotować księgę znaku? opis
                                    budowy logo i przykłady jak należy stosować
                                    znak dla prawidłowego używania
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    14. Typografia 2. Inicjały 3. Symbol lub
                                    Ikona 4. Kombinacja znak + ikona 5. Emblemat
                                    6. Inne. Podaj przykład innego. Wybieram typ
                                    logo numer:
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    15. Jakie są Państwa preferencje
                                ...
                                <Row>
                                  <Label>
                                    16. Gdzie Państwa logo będzie używane?
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.logo_gdzie}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    17. Jaki jest najważniejszy nośnik, na
                                ...
                                <Row>
                                  <Label>
                                    18. Przykłady istniejących logo, które
                                ...
                                <Row>
                                  <Label>
                                    19. Proszę podać inne dodatkowe informacje,
                            ...
                            {item.kategoria.id === 4 ? (
                              <>
                                ...
                                <Row>
                                  <Label>
                                    11. Jaki ma być podstawowy język sklepu?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    12. Czy sklep ma posiadać dodatkowe języki?
                                    Jeśli tak, to jakie?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    13. Jakie elementy, funkcjonalności powinny
                                ...
                                <Row>
                                  <Label>
                                    14. Jakie mają być główne podstrony
                                    menu/zakładki w nawigacji górnej?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    15. Jaka jest orientacyjna liczba wszystkich
                                ...
                                <Row>
                                  <Label>
                                    17. Jaka jest liczba produktów, które my
                                ...
                                <Row>
                                  <Label>
                                    18. Czy w podstronie produktu ma być coś
                                ...
                                <Row>
                                  <Label>
                                    19. Jakie są Twoje oczekiwania co do
                                    kolorystyki sklepu?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    20. Przykłady istniejących sklepów
                                    internetowych, które podobają się Tobie.
                                    Podaj minimum trzy przykłady. (nie muszą być
                                    związane z branżą)
                                  </Label>
                                ...
                                <Row>
                                  <Label>
                                    21. Elementy w istniejących sklepach
                                    internetowych, które podobają się Tobie.
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    22. Czy otrzymamy zdjęcia do wykorzystania w
                                ...
                                <Row>
                                  <Label>
                                    23. Czy otrzymamy teksty / hasła reklamowe
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.skl_teksty}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    24. Elementy zewnętrzne do umieszczenia w
                                ...
                                <Row>
                                  <Label>
                                    25. Czy jest już ustalony system płatności?
                                ...
                                <Row>
                                  <Label>
                                    26. Czy sklep ma mieć dodatkową zaawansowaną
                                ...
                                <Row>
                                  <Label>
                                    27. Czy firma posiada wykupioną domenę
                                    (adres internetowy URL)?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    28. Czy firma posiada wykupiony
                                    hosting/serwer (miejsce w którym znajdują
                                    się pliki sklepu)?
                                  </Label>
                                  <Content>
                            ...
                            {item.kategoria.id === 5 ? (
                              <>
                                ...
                                <Row>
                                  <Label>
                                    10. Czy firma posiada już intro? (animowana
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.vid_intro}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    11. Czy firma posiada już jakieś filmy
                                    promocyjne? (Jeśli tak, to prosimy o podanie
                                    linku do filmu i odpowiedź czy mamy
                                ...
                                <Row>
                                  <Label>
                                    13. Czy mają Państwo ogólną wizje/ szkielet
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.vid_wizja}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    14. Jaki ma być charakter filmu (wesoły,
                                ...
                                <Row>
                                  <Label>
                                    15. Jaka ma być przybliżona długość filmu?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    16. Kim jest główna konkurencja i czy
                                ...
                                <Row>
                                  <Label>
                                    17. Czy posiadają Państwo materiały z
                                    których mamy korzystać czy my mamy nagrywać?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    18. Jeżeli to my mamy nagrywać to jaka jest
                                ...
                                <Row>
                                  <Label>
                                    19. Przykłady istniejących filmów, które
                                ...
                                <Row>
                                  <Label>
                                    20. Elementy na istniejących filmach, które
                                ...
                                <Row>
                                  <Label>
                                    21. Czy film ma zawierać napisy?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                      ...
                                      <StaticInfo>{item.vid_napisy}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    22. Jeżeli ma zawierać napisy to czy
                                ...
                                <Row>
                                  <Label>
                                    23. Czy do kwestii mówionych firma zapewnia
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.vid_aktor}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    24. Czy firma chce ujęć z drona?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    25. Jeżeli film ma zawierać napisy to w
                                ...
                                <Row>
                                  <Label>
                                    26. Elementy dodatkowe do umieszczenia na
                                ...
                                <Row>
                                  <Label>
                                    27. Gdzie będzie wyświetlany film? (social
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.vid_gdzie}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    28. W jakiej rozdzielczości mamy wykonać
                                    film? (HD, full HD, 4K)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                            ...
                            {item.kategoria.id === 6 ? (
                              <>
                                <Row>
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.anim_logo}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                ...
                                <Row>
                                  <Label>
                                    17. Gdzie będzie publikowana animacja?
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.anim_gdzie}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    12. Czy animacja wymaga lektora? Jeśli tak,
                                ...
                                <Row>
                                  <Label>
                                    13. Czy animacja ma posiadać muzykę w tle?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    14. Jaki ma być czas trwania i ilość
                                    animacji?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    15. Jaki ma być format animacji? (mp4, avi,
                                    gif?)
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                ...
                                <Row>
                                  <Label>
                                    16. Jakie są Twoje oczekiwania co do tonu i
                                  ...
                                  <Content>
                                    {context.allowEdit(
                                      ...
                                      <StaticInfo>{item.anim_styl}</StaticInfo>
                                    )}
                                  </Content>
                                </Row>
                                <Row>
                                  <Label>
                                    17. Przykłady istniejących animacji, które
                                    podobają się Tobie. Podaj minimum trzy
                                    przykłady. (nie muszą być związane z branżą)
                                  </Label>
                                  <Content>
                                ...
                                <Row>
                                  <Label>
                                    18. Elementy na istniejących animacjach,
                                ...
                                <Row>
                                  <Label>
                                    19. Jakie materiały zostaną nam przekazane?
                                  </Label>
                                  <Content>
                                    {context.allowEdit(
                                      item.wsp_statuss,
                                ...
                                <Row>
                                  <Label>
                                    20. Czy otrzymamy scenariusz / tekst dla
                            ...
                            <Row>
                              ...
                              <Content>
                                {context.allowEdit(
                                  ...
                                  <StaticInfo>{item.wsp_zalacznik}</StaticInfo>
                                )}
                              </Content>
                            </Row>
                        ...
                        <RightWrapper>
                          ...
                          <Row status>
                            <Label>Data zmiany statusu:</Label>
                            <Content>{showDate(item.wsp_statuss_date)}</Content>
                          </Row>
